...
select * from countrylanguage where language like '%Italian%' and isofficial is true and percentage = 100;
--SMR
...
select * from city where name like '%Serra%' order by name;
...
select name, capital from country where code like '%BRA%';
--211
select id, name, district from  city where id = 211;
--Capital is Brasila
